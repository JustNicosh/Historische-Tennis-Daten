...
class PersonsAndTeamsCreator():
	...
	def __init__(self):
		self.profilesPath = '../data/competitions/tour-data/wta-premier-data/allProfilesWithSeasonIds.csv'
...
if __name__ == '__main__':
	PersonsAndTeamsCreator().write_csv('ergebnisDienst', '../data/competitions/tour-data/wta-premier-data/everyProfileWithTeamId.csv')
