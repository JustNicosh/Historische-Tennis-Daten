...
class RoundsCreator():
	...
	def __init__(self):
		self.roundsPath = '../data/competitions/tour-data/atp-500-data/allRoundsWithSeasonIds.csv'
...
if __name__ == '__main__':
	RoundsCreator().write_csv('ergebnisDienst', '../data/competitions/tour-data/atp-500-data/allRoundsWithRoundIds.csv')
