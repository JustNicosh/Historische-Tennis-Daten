...
class SeasonsCreator():
	...
	def __init__(self):
		self.roundsPath = '../data/competitions/tour-data/wta-premier-data/allDifferentRounds.csv'
...
if __name__ == '__main__':
	SeasonsCreator().write_csv('ergebnisDienst', '../data/competitions/tour-data/wta-premier-data/allRoundsWithSeasonIds.csv')
