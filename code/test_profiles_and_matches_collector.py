...
class TestProfilesAndMatchesCollector(unittest.TestCase):
    ...
    def test_return_all_different_players_and_matches(self):
        ...
        # Known data:
        self.assertEqual(len(profiles_and_matches_collector.ProfilesAndMatchesCollector().return_all_different_players_and_matches()['playerList']), 3782)
        self.assertEqual(len(profiles_and_matches_collector.ProfilesAndMatchesCollector().return_all_different_players_and_matches()['matchesList']), 45032)
    ...
    def test_return_all_grand_slam_profiles_and_matches(self):
        ...
        # Known data:
        self.assertEqual(len(profiles_and_matches_collector.ProfilesAndMatchesCollector().return_all_grand_slam_profiles_and_matches()['allGrandSlamProfiles']), 3782)
        self.assertEqual(len(profiles_and_matches_collector.ProfilesAndMatchesCollector().return_all_grand_slam_profiles_and_matches()['allGrandSlamMatches']), 45032)
