...
class TestTeamIdIdentifier(unittest.TestCase):
	...
	def test_return_profiles_and_teams(self):
		"""Do all csvs return content (known data -> 3782 and at least 4700)?
        """
	...
	def test_return_profiles_with_team_id(self):
		"""Are all profiles returned and many with a team_id (known data -> 3782 and at least 900)?
		"""
	...
	def test_write_csv(self):
		"""Do we write one csv file with team_id profile rows (known data -> 3782)?
        """
